{-# LANGUAGE TypeOperators, TypeFamilies, FlexibleInstances, MultiParamTypeClasses, EmptyDataDecls, TypeSynonymInstances, NoMonomorphismRestriction #-}
-----------------------------------------------------------------------------
--
-- Module      :  Shader
...
module Client.Graphics.GPipe.Inner.Shader (
    GPU(..),
    rasterizeVertex,
    inputVertex,
    fragmentFrontFacing,
...
-- | Window space x coordinate of local fragment
fragX :: Fragment Float
-- | Window space y coordinate of local fragment
fragY :: Fragment Float
